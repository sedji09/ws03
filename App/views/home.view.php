...
<!-- Job Listings -->
<section>
  <div class="container mx-auto p-4 mt-4 container-padding">
    <div class="text-center text-3xl mb-4 font-bold border border-gray-300 p-3 recent-jobs-heading">Recent Jobs</div>
        ...
        <div class="rounded-lg shadow-md bg-white" style="display: flex; flex-direction: column; height: 100%;">
          <div class="p-4" style="display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <a href="/listings/<?= $listing->id ?>"
              class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium text-indigo-700 bg-indigo-100 hover:bg-indigo-200" style="margin-top: auto;">
              Details
            </a>
          </div>
        </div>
    ...
    <a href="/listings" class="block text-xl text-center show-all-btn">
