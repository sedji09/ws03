...
<section class="container mx-auto p-4 mt-4 max-w-4xl">
  <?php loadPartial('message') ?>
  <div class="rounded-lg shadow-md bg-white p-3">
    <div class="flex justify-between items-center">
      <a class="block p-4" href="/listings" style="color: #2563eb;">
...
<section class="container mx-auto p-4 max-w-4xl">
  ...
  <a href="mailto:<?= $listing->email ?>"
    class="apply-btn block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium cursor-pointer text-indigo-700 bg-indigo-100 hover:bg-indigo-200">
    Apply Now
  </a>
</section>
