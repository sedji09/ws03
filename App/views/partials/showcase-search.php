...
<section class="showcase relative bg-cover bg-center bg-no-repeat h-72 flex items-center">
  ...
  <div class="container mx-auto text-center z-10">
    ...
    <form method="GET" action="/listings/search" class="mb-4 mx-5 md:mx-auto">
      <div class="flex flex-col md:flex-row md:items-center md:justify-center gap-2">
        ...
        <button class="w-full md:w-auto post-job-btn text-white px-4 py-2 focus:outline-none rounded hover:shadow-md transition duration-300">
